...
import NotificationDropdown, { NotificationPanel } from "./NotificationDropdown";
...
function NavBar() {
  ...
  const { mappedForDropdown, markAsRead, markAllAsRead, loading: notifLoading } = useSupabaseNotifications();
      ...
      {!isAuthenticated ? (
        <>
          <div className=" hidden md:flex items-center gap-3 ">
            <Button variant="secondary" onClick={() => handleNavigate("/login")}>
              Log in
            </Button>
          ...
          <div className="flex md:hidden items-center">
            <button type="button" onClick={() => setListToggle(!listToggle)}>
          ...
          {listToggle && (
            <div className="absolute right-[0.5px] top-12 p-6 bg-white/95 w-full shadow-lg flex flex-col gap-4 md:hidden">
              <Button variant="secondary" onClick={() => handleNavigate("/login")} className="cursor-pointer">
                Log in
              </Button>
              <Button className="cursor-pointer" onClick={() => handleNavigate("/signup")}>
                Sign up
              </Button>
            </div>
          )}
        ...
        <>
          <div className="hidden md:flex items-center gap-3">
            ...
            <div className="relative">
              ...
              >
                ...
                />
                <span className="text-brown-600 font-medium line-clamp-1 max-w-[100px]">{displayName}</span>
            ...
            <div className="absolute left-0 right-0 top-12 bg-white shadow-lg md:hidden z-50">
              <div className="flex items-center justify-between px-4 py-4 border-b border-brown-200">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-brown-600 font-medium">{displayName}</span>
                </div>
                <button
                  type="button"
                  className="p-2 rounded-full border border-brown-200 relative"
                  onClick={() => {
                ...
                >
                  ...
                  {mappedForDropdown.some((n) => n.unread) && (
          ...
          {mobileNotifOpen && (
            ...
            >
              <div
                className="absolute top-12 left-0 right-0 max-h-[80vh] overflow-hidden rounded-b-xl"
